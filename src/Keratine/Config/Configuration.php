    ...
    private function buildOrmThree()
    {
        ...
        $node
            ->children()
                ...
                ->scalarNode('add_mapping_driver')->end()
                ->scalarNode('em_name_from_param')->end()
                ->scalarNode('generate_psr0_mapping')->end()
                ->arrayNode('em')
                    ->children()
                        ->arrayNode('options')
                            ->children()
                                ...
                                ->arrayNode('mappings')
                                    ...
                                    ->end()
                                ->end()
                                ->scalarNode('query_cache')->end()
                                ->scalarNode('metadata_cache')->end()
